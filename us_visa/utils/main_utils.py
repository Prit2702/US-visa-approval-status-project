...
def read_yaml_fiel(file_path: str) -> dict:
    try:
...
def save_numpy_array_data(file_path: str, array: np.array):
    """
    Save numpy array datato file
    file_path: str locaton of file to save
...
def drop_columns(df: DataFrame, columns: list) -> DataFrame:
    """
    Drop columns form a pandas DataFrame
    df: pandas DataFrame
    cols: list of columns to dropped
    """
